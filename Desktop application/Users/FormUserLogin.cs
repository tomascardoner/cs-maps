...
namespace CSMaps.Users
{
    public partial class FormUserLogin : Form
    {
        ...
        private void Aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (!CardonerSistemas.Framework.Cryptography.StringCipher.Decrypt(usuario.Password, Constants.PublicEncryptionPassword, out string decryptedPassword, out string decryptionResultMessage))
            {
                usuario = null;
                this.Cursor = Cursors.Default;
